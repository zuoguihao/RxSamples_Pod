...
extension ObservableType {
    ...
    public func bindTo<O : ObserverType>(_ observer: O?) -> Disposable? where O.E == E {
        ...
        let disposable: Disposable = bind(to: observer)
        return disposable
    }
    ...
    public func bindTo(_ variable: RxSwift.Variable<E>?) -> Disposable? {
        ...
        let disposable: Disposable = bind(to: variable)
        return disposable
    }
    
    public func bindTo(_ variable: RxSwift.Variable<Optional<E>>) -> Disposable {
        return map(Optional.init).bind(to: variable)
    }
    ...
    public func bindTo<O : ObserverType>(_ observer: O?) -> Disposable? where O.E == Optional<E> {
        ...
        let disposable: Disposable = map(Optional.init).bind(to: observer)
        return disposable
    }
    ...
    public func bindTo(_ variable: RxSwift.Variable<Optional<E>>?) -> Disposable? {
        ...
        let disposable: Disposable = map(Optional.init).bind(to: variable)
        return disposable
    }
